...
{
    QSqlQueryModel *modelProduit = new QSqlQueryModel;
    modelProduit->setQuery("Select num_Produit,Produit.num_Fourni,nom_Fourni,ref_Produit,nom_Produit,pu_Produit,lib_typeProduit,um_Produit FROM Produit inner join TypeProduit on Produit.type_Produit=TypeProduit.num_TypeProduit inner join Fournisseur on Produit.num_Fourni=Fournisseur.num_Fourni where Produit.active=0 ");
    modelProduit->setHeaderData(2, Qt::Horizontal, tr("nom du fournisseur"));
    modelProduit->setHeaderData(3, Qt::Horizontal, tr("Reference"));
    modelProduit->setHeaderData(4, Qt::Horizontal, tr("Nom commercial"));
    modelProduit->setHeaderData(5, Qt::Horizontal, tr("Prix unitaire"));
...
{    
    ...
    statusBar()->showMessage(trUtf8("Le produit "+nom.toLatin1()+" a été enregistré correctement."));
    this->ChargeProduit("%","%");
}
...
void MainWindow::on_pushButton_Mod_Fourni_clicked()
{
    ...
    this->ChargeUi();
    ui->stackedWidget->setCurrentIndex(2);
    statusBar()->showMessage(trUtf8("Le fournisseur "+nom.toLatin1()+" a été modifié correctement."));
}
...
void MainWindow::on_pushButton_Ajout_Fourni_clicked()
{
    ...
    statusBar()->showMessage(trUtf8("Le fournisseur "+nom.toLatin1()+" a été enregistré correctement."));
    this->ChargeFourni();
}
...
void MainWindow::on_pushButton_Mod_Prod_clicked()
{
    ...
    req.first();
    this->ChargeProduit("%","%");
    statusBar()->showMessage(trUtf8("Le produit "+nom.toLatin1()+" a été modifié correctement."));
    ui->stackedWidget->setCurrentIndex(3);
}
...
void MainWindow::on_pushButton_Suppr_Prod_clicked()
{
    ...
    ui->stackedWidget->setCurrentIndex(3);
    statusBar()->showMessage(trUtf8("Le produit "+nom.toLatin1()+" a été supprimé correctement."));
    this->ChargeUi();
...
void MainWindow::on_pushButton_Suppr_Fourni_clicked()
{
    ...
    ui->stackedWidget->setCurrentIndex(2);
    this->ChargeProduit("%","%");
    statusBar()->showMessage(trUtf8("Le fournisseur "+nom.toLatin1()+" a été supprimé correctement."));
    this->ChargeUi();
