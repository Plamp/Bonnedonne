...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        gridLayout->addWidget(frame_Logo, 0, 0, 2, 1);
        ...
        gridLayout->addWidget(label, 3, 0, 1, 5);
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        label_Titre->setText(QApplication::translate("Dialog", "BackOffice-Gestcout", 0, QApplication::UnicodeUTF8));
